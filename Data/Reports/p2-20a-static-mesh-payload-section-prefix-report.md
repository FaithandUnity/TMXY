...
This is a hash-locked `SOURCE_DERIVED` diagnostic. No legacy binary was executed, runtime parity was not proven, and no adapter, recovery, selection, disposition, repair, or authority change occurred. A.4 remains authoritative; the current A.4/A.7/A.8 chain reconciles to 6 unresolved targets / 9 unresolved edges; G2-06 and P3 remain blocked.
