...
$requiredFiles = @(
    ...
    'Data/Inventory/p2-20a-aux-ecf-parser-parity.json',
    'Data/Inventory/p2-20a-asset-descriptor-diagnostics.json',
    'Data/Inventory/p2-20a-asset-identity-normalization.json',
    ...
    'Data/Reports/p2-20a-aux-ecf-parser-parity-report.json',
    'Data/Reports/p2-20a-aux-ecf-parser-parity-report.md',
    'Data/Reports/p2-20a-asset-descriptor-diagnostics-report.json',
    'Data/Reports/p2-20a-asset-descriptor-diagnostics-report.md',
    'Data/Reports/p2-20a-asset-identity-normalization-report.json',
    'Data/Reports/p2-20a-asset-identity-normalization-report.md',
    ...
    'Docs/Formats/G2-AUX-ECF-PARSER-PARITY.md',
    'Docs/Formats/G2-AUX-MALFORMED-XML-DIAGNOSTICS.md',
    'Docs/Formats/G2-ASSET-DESCRIPTOR-DIAGNOSTICS.md',
    'Docs/Formats/G2-ASSET-IDENTITY-NORMALIZATION.md',
    ...
    'Contracts/data-schema/g2-aux-ecf-parser-parity-policy-v1.json',
    'Contracts/data-schema/g2-aux-ecf-parser-parity-v1.schema.json',
    'Contracts/data-schema/g2-aux-ecf-parser-parity-detail-v1.schema.json',
    ...
    'Contracts/data-schema/g2-asset-identity-normalization-policy-v1.json',
    'Contracts/data-schema/g2-asset-identity-normalization-v1.schema.json',
    ...
    'Tests/Contract/Test-G2AuxEcfParserParity.ps1',
    'Tests/Contract/Test-G2AuxMalformedXmlDiagnostics.ps1',
    ...
    'Tools/TMXY.G2AuxEcfParserParity/README.md',
    'Tools/TMXY.G2AuxEcfParserParity/g2_aux_ecf_parser_parity.py',
    'Tools/TMXY.G2AuxEcfParserParity/aux_ecf_parser_parity_support.py',
    ...
    'Contracts/data-schema/g2-aux-malformed-xml-diagnostics-policy-v1.json',
    'Contracts/data-schema/g2-aux-malformed-xml-diagnostics-v1.schema.json',
    'Data/Inventory/p2-20a-aux-malformed-xml-diagnostics.json',
    'Data/Reports/p2-20a-aux-malformed-xml-diagnostics-report.json',
    'Data/Reports/p2-20a-aux-malformed-xml-diagnostics-report.md',
    'Tools/TMXY.G2AuxMalformedXmlDiagnostics/README.md',
    'Tools/TMXY.G2AuxMalformedXmlDiagnostics/aux_malformed_xml_support.py',
    'Tools/TMXY.G2AuxMalformedXmlDiagnostics/g2_aux_malformed_xml_diagnostics.py',
    'Tools/TMXY.G2AuxMalformedXmlDiagnostics/g2_aux_malformed_xml_evidence.py',
    'Tools/TMXY.G2AuxMalformedXmlDiagnostics/New-G2AuxMalformedXmlDiagnostics.ps1',
    'Tools/TMXY.G2AuxMalformedXmlDiagnostics/tinyxml_probe.cpp',
    ...
    'Tools/TMXY.G2AssetDescriptorDiagnostics/diagnostic_self_test.py',
    ...
    'Tools/TMXY.G2AssetIdentityNormalization/README.md',
    'Tools/TMXY.G2AssetIdentityNormalization/identity_normalization.py',
    'Tools/TMXY.G2AssetIdentityNormalization/New-G2AssetIdentityNormalization.ps1',
    'Contracts/data-schema/g2-asset-binding-failure-detail-v1.schema.json',
    'Contracts/data-schema/g2-asset-binding-failure-diagnostics-policy-v1.json',
    'Contracts/data-schema/g2-asset-binding-failure-diagnostics-v1.schema.json',
    'Data/Inventory/p2-20a-asset-binding-failure-diagnostics.json',
    'Data/Reports/p2-20a-asset-binding-failure-diagnostics-report.json',
    'Data/Reports/p2-20a-asset-binding-failure-diagnostics-report.md',
    'Docs/Formats/G2-ASSET-BINDING-FAILURE-DIAGNOSTICS.md',
    'Tests/Contract/Test-G2AssetBindingFailureDiagnostics.ps1',
    'Tools/TMXY.G2AssetBindingFailureDiagnostics/CMakeLists.txt',
    'Tools/TMXY.G2AssetBindingFailureDiagnostics/README.md',
    ...
    'Tools/TMXY.G2AssetBindingFailureDiagnostics/apps/failure_probe_main.cpp',
    ...
    'Tools/TMXY.G2Review/g2_aux_ecf_parser_parity.py',
    'Tools/TMXY.G2Review/g2_aux_malformed_xml.py',
